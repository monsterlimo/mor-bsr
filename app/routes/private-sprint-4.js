...
module.exports = router => {
    ...
    router.post('/private-sprint-4/about-the-building/have-existing-applications', (req, res) => {
        if (req.session.data['existing-application'] == "bcr") {
            res.redirect('/private-sprint-4/about-the-building/enter-bcr-number')
        } else if (req.session.data['existing-application'] == "hrb") {
            res.redirect('/private-sprint-4/about-the-building/enter-hrb-number')
        } else {
            res.redirect('/private-sprint-4/about-the-building/is-the-building-occupied')
        }
    })

    router.post('/private-sprint-4/about-the-building/is-the-building-occupied', (req, res) => {
        if (req.session.data['building-status'] == "in design") {
            res.redirect('/private-sprint-4/about-the-building/design-status')
        } else {
            res.redirect('/private-sprint-4/about-the-building/have-an-address')
        }
    })

    router.post('/private-sprint-4/about-the-building/design-status', (req, res) => {
        if (req.session.data['design-status'] == "yes") {
            res.redirect('/private-sprint-4/about-the-building/enter-bcr-number')
        } else {
            res.redirect('/private-sprint-4/about-the-building/mor-not-required')
        }
    })

    router.post('/private-sprint-4/about-the-building/have-an-address', (req, res) => {
        if (req.session.data['has-address'] == "yes") {
            res.redirect('/private-sprint-4/about-the-building/postcode-lookup')
        } else {
            res.redirect('/private-sprint-4/about-the-building/choose-how-to-locate-building')
        }
    })
/*
    router.post('/private-sprint-4/about-the-building/have-an-address', (req, res) => {
    ...
    router.post('/private-sprint-4/about-the-building/choose-how-to-locate-building', (req, res) => {
        res.redirect('/private-sprint-4/about-the-person/your-details')
    })
...
*/
    router.post('/private-sprint-4/about-the-building/enter-hrb-number', (req, res) => {
        res.redirect('/private-sprint-4/about-the-building/confirm-address')
    })

    router.post('/private-sprint-4/about-the-building/enter-bcr-number', (req, res) => {
        res.redirect('/private-sprint-4/about-the-building/confirm-address')
    })
    ...
    router.post('/private-sprint-4/about-the-building/which-region', (req, res) => {
        if (req.session.data['building-region'] == "england") {
            ...
            res.redirect('/private-sprint-4/about-the-building/not-in-england')
        }
    })
    ...
    router.post('/private-sprint-4/about-the-person/select-organisation', (req, res) => {
        res.redirect('/private-sprint-4/about-the-person/your-details')
    })
...
/*
    ...
    router.post('/private-sprint-4/about-the-person/your-role', (req, res) => {
        ...
        if (roles) {
            if (roles.length == 1) {
                roles.forEach(role => {
                    if (role == "other") {
                        res.redirect('/private-sprint-4/about-the-person/not-able-to-submit')
                    } else {
    ...
    */
    ...
    router.post('/private-sprint-4/building-in-scope/number-of-floors', (req, res) => {
        res.redirect('/private-sprint-4/building-in-scope/height-of-building')   
    })

    router.post('/private-sprint-4/building-in-scope/height-of-building', (req, res) => {
    ...
    router.post('/private-sprint-4/building-in-scope/number-of-units', (req, res) => {
        ...
        if (inScope) {
            ...
            res.redirect('/private-sprint-4/building-in-scope/not-in-scope')
        }
    })

...
module.exports = router => {
    router.post('/sprint-6/start', (req, res) => {
        res.redirect('/sprint-6/about-the-person/type-of-person')
    })
    ...
    router.post('/sprint-6/about-the-person/enter-your-contact-details', (req, res) => {
        if (req.session.data['enquiry-about'] == "mor") {
            res.redirect('/sprint-6/about-the-person/what-is-your-role')
        } else if (req.session.data['enquiry-about'] == "complaint") {
            if (req.session.data['about-a-building'] == "yes") {
                res.redirect('/sprint-6/about-the-ap/share-details-with-ap')
            } else {

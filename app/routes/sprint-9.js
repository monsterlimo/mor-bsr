...
module.exports = router => {
    router.post('/sprint-9/start', (req, res) => {
    ...
    router.post('/sprint-9/about-the-building/postcode-lookup', (req, res) => {
        res.redirect('/sprint-9/about-the-building/choose-address')
    })
    ...
    router.post('/sprint-9/about-the-building/which-region', (req, res) => {
        if (req.session.data['building-region'] == "england") {
            ...
            res.redirect('/sprint-9/about-the-building/not-in-england')
        }
    })
    ...
    router.post('/sprint-9/building-in-scope/number-of-floors', (req, res) => {
        res.redirect('/sprint-9/building-in-scope/height-of-building')   
    })

    router.post('/sprint-9/building-in-scope/height-of-building', (req, res) => {
    ...
    router.post('/sprint-9/building-in-scope/number-of-units', (req, res) => {
        ...
        if (inScope) {
            ...
            res.redirect('/sprint-9/building-in-scope/not-in-scope')
        }
    })
